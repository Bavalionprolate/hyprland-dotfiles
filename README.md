...
- Откройте меню обзора приложений, нажав `Alt + R`.
...
9. Overview.
   ...
   Используя комбинацию клавиш `Meta + Tab`, вы сможете вызвать Overview и просмотреть все приложения на всех workspaces. Переключить фокус в overview вы можете мышкой или через комбинации клавиш `Alt + Tab` или используя `Meta + Arrows` и что бы переместиться к сфокусированному приложению вы можете нажать по `левой кнопки мыши` или нажав еще раз `Meta + Tab`.
