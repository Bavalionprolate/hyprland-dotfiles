...
4. Вызов плеера
- Нажмите сочитание клавиш `Alt + P` для выозва плеера. С помощю данного виджета можно взаимодействовать с потоком музыке, будь то она из браузера или какого-либо проигрователя.
