...
~~~
yay -S ttf-twemoji waybar-hyprland-git hyprland-nvidia-git kitty ttf-jetbrains-mono-nerd pavucontrol jq nvidia-settings libnotify dunst slurp grim wl-clipboard xdg-desktop-portal-hyprland libcanberra swaylock-effects wireless_tools pamixer xdg-user-dirs blueberry wlrobs-hg lsd adw-gtk-theme
~~~
...
5. Меню быстрых настроек. Для вызова меню быстрых настроек нажмите сочитание клавиш `Alt + с`. В данном меню есть виджет:
...
6. Быстрый индикатор звука. Данный индикатор отображает звук при изменении его через: 
